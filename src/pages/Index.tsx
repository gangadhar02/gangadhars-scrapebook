...
const Index = () => {
  ...
  return <div className="min-h-screen relative overflow-hidden paper-texture">
      ...
      {!isCreating && <div className="fixed bottom-8 right-8 z-20">
          <button onClick={handleStartCreating} className="bg-scrapbook-yellow hover:bg-yellow-300 text-amber-800 font-handwritten font-bold py-4 px-6 rounded-lg shadow-lg transform hover:scale-105 transition-all duration-200 animate-pulse-glow border-2 border-amber-200">
            📝 Leave a Note
          </button>
        </div>}
